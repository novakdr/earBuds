    ...
    render() {
        return (
            ...
            <div className="main_page">
                    ...
                    <img className="buds" src="https://imgur.com/Nappfnh.gif"></img>
                    <p className="description">Tune in with EarBuds and go beyond from just listening. Now interact with your favorite Podcasts!</p>
            </div>   
